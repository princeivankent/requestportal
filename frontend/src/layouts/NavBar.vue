    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container">
        <a class="navbar-brand" to="/home">
          <img src="@/assets/isuzu-logo-compressor.png" width="30" height="30" class="d-inline-block align-top" alt="">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            <li class="nav-item">
              <router-link class="nav-link" to="/home" active-class="active">Home <span class="sr-only">(current)</span></router-link>
            </li>
            <li class="nav-item">
